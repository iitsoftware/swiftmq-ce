...
public class QueueConnectionImpl extends ConnectionImpl
    ...
    public QueueSession createQueueSession(boolean transacted,
        ...
        com.swiftmq.jms.smqp.v400.CreateSessionReply reply = null;

        try {
            reply =
                    (com.swiftmq.jms.smqp.v400.CreateSessionReply) requestRegistry.request(new com.swiftmq.jms.smqp.v400.CreateSessionRequest(transacted,
                            acknowledgeMode, com.swiftmq.jms.smqp.v400.CreateSessionRequest.QUEUE_SESSION));
        } catch (Exception e) {
