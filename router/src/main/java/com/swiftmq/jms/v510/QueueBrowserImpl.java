...
import com.swiftmq.jms.smqp.v510.FetchBrowserMessageReply;
import com.swiftmq.jms.smqp.v510.FetchBrowserMessageRequest;
...
public class QueueBrowserImpl implements QueueBrowser, Enumeration {
    ...
    public void close() throws JMSException {
        ...
        try {
            reply = requestRegistry.request(new com.swiftmq.jms.smqp.v510.CloseBrowserRequest(dispatchId,
                    browserDispatchId));
        } catch (Exception e) {
