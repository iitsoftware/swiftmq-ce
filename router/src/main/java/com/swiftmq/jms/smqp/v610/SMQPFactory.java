...
/**
 * SMQP-Protocol Version 610, Class: SMQPFactory
...
public class SMQPFactory extends DumpableFactory {
    ...
    public static final int DID_XARESGETTXTIMEOUT_REQ = 169;
    public static final int DID_XARESGETTXTIMEOUT_REP = 170;
    public static final int DID_XARESPREPARE_REQ = 171;
    public static final int DID_XARESPREPARE_REP = 172;
    public static final int DID_XARESRECOVER_REQ = 173;
    public static final int DID_XARESRECOVER_REP = 174;
    public static final int DID_XARESROLLBACK_REQ = 175;
    public static final int DID_XARESROLLBACK_REP = 176;
    public static final int DID_XARESSETTXTIMEOUT_REQ = 177;
    public static final int DID_XARESSETTXTIMEOUT_REP = 178;
    public static final int DID_XARESSTART_REQ = 179;
    public static final int DID_XARESSTART_REP = 180;
