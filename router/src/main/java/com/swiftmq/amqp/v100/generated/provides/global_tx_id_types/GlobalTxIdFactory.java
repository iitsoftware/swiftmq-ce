...
public class GlobalTxIdFactory {
     ...
     * @return GlobalTxIdIF
     */
    public static GlobalTxIdIF create(AMQPType bare) throws Exception {
        if (bare.getCode() == AMQPTypeDecoder.NULL)
            return null;
        return new BinaryTxId(((AMQPBinary) bare).getValue());
    }
     ...
     * @return native array
     */
    public static GlobalTxIdIF[] toNativeArray(AMQPArray array) throws Exception {
        if (array == null)
            return null;
        AMQPType[] value = array.getValue();
        if (value == null)
            return null;
        GlobalTxIdIF[] n = new GlobalTxIdIF[value.length];
