...
public class DeleteOnClose extends AMQPList
        implements LifetimePolicyIF {
    public static String DESCRIPTOR_NAME = "amqp:delete-on-close:list";
    public static long DESCRIPTOR_CODE = 0x00000000L << 32 | 0x0000002bL;
    ...
    /**
     * Returns the predicted size of this DeleteOnClose. The predicted size may be greater than the actual size
    ...
    public String getValueString() {
        ...
        StringBuffer b = new StringBuffer("[DeleteOnClose ");
    ...
    public String toString() {
        return "[DeleteOnClose " + getDisplayString() + "]";
    }
}
