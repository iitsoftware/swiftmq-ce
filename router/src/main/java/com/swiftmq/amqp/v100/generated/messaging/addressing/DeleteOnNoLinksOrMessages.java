...
public class DeleteOnNoLinksOrMessages extends AMQPList
        implements LifetimePolicyIF {
    public static String DESCRIPTOR_NAME = "amqp:delete-on-no-links-or-messages:list";
    public static long DESCRIPTOR_CODE = 0x00000000L << 32 | 0x0000002eL;
     ...
     */
    public DeleteOnNoLinksOrMessages(List initValue) throws Exception {
        super(initValue);
        if (initValue != null)
            decode();
    }
    ...
    /**
     * Returns the predicted size of this DeleteOnNoLinksOrMessages. The predicted size may be greater than the actual size
    ...
    public String getValueString() {
        ...
        StringBuffer b = new StringBuffer("[DeleteOnNoLinksOrMessages ");
    ...
    public String toString() {
        return "[DeleteOnNoLinksOrMessages " + getDisplayString() + "]";
    }
}
