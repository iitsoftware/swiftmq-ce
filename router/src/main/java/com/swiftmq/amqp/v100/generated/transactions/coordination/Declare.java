...
import com.swiftmq.amqp.v100.generated.provides.global_tx_id_types.GlobalTxIdFactory;
import com.swiftmq.amqp.v100.generated.provides.global_tx_id_types.GlobalTxIdIF;
 ...
 * controller and identified in the   resulting outcome.
 * </p><p>
 * </p><p>
 * </p>
 *
...
public class Declare extends AMQPList {
    public static String DESCRIPTOR_NAME = "amqp:declare:list";
    public static long DESCRIPTOR_CODE = 0x00000000L << 32 | 0x00000031L;
     ...
     */
    public Declare(List initValue) throws Exception {
        super(initValue);
        if (initValue != null)
            decode();
    }
     ...
     * @return GlobalId
     */
    public GlobalTxIdIF getGlobalId() {
        return globalId;
    }
     ...
     */
    public void setGlobalId(GlobalTxIdIF globalId) {
        dirty = true;
        this.globalId = globalId;
    }

    /**
     * Returns the predicted size of this Declare. The predicted size may be greater than the actual size
    ...
    public int getPredictedSize() {
        ...
        if (dirty) {
            ...
            n += (globalId != null ? globalId.getPredictedSize() : 1);
            setConstructor(_c);
        } else
            n = super.getPredictedSize();
        return n;
    ...
    private void decode() throws Exception {
        ...
        // Field: globalId
        // Type     : GlobalTxIdIF, converted: GlobalTxIdIF
        // Basetype : GlobalTxIdIF
        // Default  : null
        // Mandatory: false
        // Multiple : false
        // Factory  : GlobalTxIdFactory
        if (idx >= l.size())
            return;
        t = (AMQPType) l.get(idx++);
        if (t.getCode() != AMQPTypeDecoder.NULL)
            globalId = GlobalTxIdFactory.create(t);
    }
    ...
    public String getValueString() {
        ...
        StringBuffer b = new StringBuffer("[Declare ");
    ...
    private String getDisplayString() {
        ...
        if (globalId != null) {
            if (!_first)
                ...
                _first = false;
            b.append("globalId=");
            b.append(globalId.getValueString());
        }
        return b.toString();
    }

    public String toString() {
        return "[Declare " + getDisplayString() + "]";
    }
}
