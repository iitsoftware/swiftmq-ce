...
public class ResourceLimitGroup
{
   ...
   * @exception ResourceLimitException if max. sessions is exceeded
   */
   ...
   * @exception ResourceLimitException if max. temp. queues/topics is exceeded
   */
   ...
   * @exception ResourceLimitException if max. producers is exceeded
   */
   ...
   * @exception ResourceLimitException if max. consumers is exceeded
   */
