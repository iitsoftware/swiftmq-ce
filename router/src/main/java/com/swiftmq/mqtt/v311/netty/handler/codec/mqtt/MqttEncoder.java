...
import com.swiftmq.mqtt.v311.netty.util.internal.EmptyArrays;
...
public final class MqttEncoder {
    ...
    public static com.swiftmq.mqtt.v311.netty.buffer.ByteBuf doEncode(MqttMessage message) {
    ...
    private static com.swiftmq.mqtt.v311.netty.buffer.ByteBuf encodeConnectMessage(
        ...
        byte[] willTopicBytes = willTopic != null ? encodeStringUtf8(willTopic) : com.swiftmq.mqtt.v311.netty.util.internal.EmptyArrays.EMPTY_BYTES;
        byte[] willMessage = payload.willMessageInBytes();
        byte[] willMessageBytes = willMessage != null ? willMessage : com.swiftmq.mqtt.v311.netty.util.internal.EmptyArrays.EMPTY_BYTES;
        ...
        byte[] userNameBytes = userName != null ? encodeStringUtf8(userName) : com.swiftmq.mqtt.v311.netty.util.internal.EmptyArrays.EMPTY_BYTES;
        ...
        com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buf = new com.swiftmq.mqtt.v311.netty.buffer.ByteBuf(fixedHeaderBufferSize + variablePartSize);
    ...
    private static com.swiftmq.mqtt.v311.netty.buffer.ByteBuf encodeConnAckMessage(
            MqttConnAckMessage message) {
        com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buf = new com.swiftmq.mqtt.v311.netty.buffer.ByteBuf(4);
    ...
    private static com.swiftmq.mqtt.v311.netty.buffer.ByteBuf encodeSubscribeMessage(
    ...
    private static com.swiftmq.mqtt.v311.netty.buffer.ByteBuf encodeUnsubscribeMessage(
    ...
    private static com.swiftmq.mqtt.v311.netty.buffer.ByteBuf encodeSubAckMessage(
    ...
    private static com.swiftmq.mqtt.v311.netty.buffer.ByteBuf encodePublishMessage(
            MqttPublishMessage message) {
        MqttFixedHeader mqttFixedHeader = message.fixedHeader();
        MqttPublishVariableHeader variableHeader = message.variableHeader();
        com.swiftmq.mqtt.v311.netty.buffer.ByteBuf payload = message.payload().duplicate();
    ...
    private static com.swiftmq.mqtt.v311.netty.buffer.ByteBuf encodeMessageWithOnlySingleByteFixedHeaderAndMessageId(
            MqttMessage message) {
        MqttFixedHeader mqttFixedHeader = message.fixedHeader();
        ...
        com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buf = new com.swiftmq.mqtt.v311.netty.buffer.ByteBuf(fixedHeaderBufferSize + variableHeaderBufferSize);
        buf.writeByte(getFixedHeaderByte1(mqttFixedHeader));
    ...
    private static com.swiftmq.mqtt.v311.netty.buffer.ByteBuf encodeMessageWithOnlySingleByteFixedHeader(
            MqttMessage message) {
        MqttFixedHeader mqttFixedHeader = message.fixedHeader();
        com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buf = new com.swiftmq.mqtt.v311.netty.buffer.ByteBuf(2);
        buf.writeByte(getFixedHeaderByte1(mqttFixedHeader));
        buf.writeByte(0);
