...
public class MqttPublishMessage extends MqttMessage {
    ...
    public MqttPublishMessage(
            ...
            com.swiftmq.mqtt.v311.netty.buffer.ByteBuf payload) {
    ...
    @Override
    public com.swiftmq.mqtt.v311.netty.buffer.ByteBuf payload() {
        return content();
    }

    public com.swiftmq.mqtt.v311.netty.buffer.ByteBuf content() {
        final com.swiftmq.mqtt.v311.netty.buffer.ByteBuf data = (com.swiftmq.mqtt.v311.netty.buffer.ByteBuf) super.payload();
        return data;
    }
