...
public final class MqttDecoder {
     ...
     */
    private static MqttFixedHeader decodeFixedHeader(com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buffer) {
     ...
     */
    private static Result<?> decodeVariableHeader(com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buffer, MqttFixedHeader mqttFixedHeader) {
    ...
    private static Result<MqttConnectVariableHeader> decodeConnectionVariableHeader(com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buffer) {
    ...
    private static Result<MqttConnAckVariableHeader> decodeConnAckVariableHeader(com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buffer) {
    ...
    private static Result<MqttMessageIdVariableHeader> decodeMessageIdVariableHeader(com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buffer) {
    ...
    private static Result<MqttPublishVariableHeader> decodePublishVariableHeader(
            com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buffer,
    ...
    private static Result<Integer> decodeMessageId(com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buffer) {
    ...
    private static Result<com.swiftmq.mqtt.v311.netty.buffer.ByteBuf> decodePublishPayload(com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buffer, int bytesRemainingInVariablePart) {
        com.swiftmq.mqtt.v311.netty.buffer.ByteBuf b = buffer.readRetainedSlice(bytesRemainingInVariablePart);
        return new Result<com.swiftmq.mqtt.v311.netty.buffer.ByteBuf>(b, bytesRemainingInVariablePart);
    }

    private static Result<String> decodeString(com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buffer) {
        return decodeString(buffer, 0, Integer.MAX_VALUE);
    }

    private static Result<String> decodeString(com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buffer, int minBytes, int maxBytes) {
    ...
    private static Result<byte[]> decodeByteArray(com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buffer) {
        final Result<Integer> decodedSize = decodeMsbLsb(buffer);
        int size = decodedSize.value;
    ...
    private static Result<Integer> decodeMsbLsb(com.swiftmq.mqtt.v311.netty.buffer.ByteBuf buffer) {
