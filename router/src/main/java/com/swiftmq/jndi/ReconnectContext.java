    ...
    do
    {
      ...
      if (current != null)
      {
        try
        {
          ...
          if (debug) System.out.println(new Date() + " " + toString() + "/runWrapped, execute done, result=" + obj);
        } catch (CommunicationException e)
        {
          if (debug) System.out.println(new Date() + " " + toString() + "/runWrapped, CommunicationException=" + e);
          current = null;
