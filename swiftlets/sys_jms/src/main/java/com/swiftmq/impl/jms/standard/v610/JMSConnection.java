...
public class JMSConnection
    ...
    public JMSConnection(SwiftletContext ctx, Entity connectionEntity, Connection connection) {
        ...
        connectionId = "v610/" + connection.toString();
    ...
    public void startAccounting(AccountingProfile accountingProfile) {
        ctx.logSwiftlet.logWarning(tracePrefix, "This SMQP protocol version (v610) does NOT support accounting! Please upgrade this client to use accounting!");
    }
