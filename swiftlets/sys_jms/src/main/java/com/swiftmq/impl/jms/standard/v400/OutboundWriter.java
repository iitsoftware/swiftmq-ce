...
import com.swiftmq.jms.smqp.v400.KeepAliveRequest;
import com.swiftmq.jms.smqp.v400.SMQPBulkRequest;
import com.swiftmq.jms.smqp.v400.SMQPFactory;
...
public class OutboundWriter
    ...
    OutboundWriter(Connection connection) {
