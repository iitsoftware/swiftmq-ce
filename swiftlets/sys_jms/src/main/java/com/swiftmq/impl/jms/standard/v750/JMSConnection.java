...
public class JMSConnection
    ...
    public JMSConnection(SwiftletContext ctx, Entity connectionEntity, Connection connection) {
        ...
        connectionId = "v750/" + connection.toString();
    ...
    class ConnectionVisitor extends ConnectionVisitorAdapter {
        ...
        public void visit(DeleteTmpQueueRequest req) {
            ...
            try {
                ...
                AbstractQueue tq = ctx.queueManager.getQueueForInternalUse(tmpQueueName);
                if (tq.getReceiverCount() > 0)
                    throw new JMSException("Can't delete temporary queue '" + tmpQueueName + "' because it has active consumers!");
