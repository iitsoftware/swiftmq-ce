    ...
    implements RequestService, VersionedJMSConnection
{
  ...
  public JMSConnection(SwiftletContext ctx, Entity connectionEntity, Connection connection)
  {
    ...
    connectionId = "v630/" + connection.toString();
  ...
  {
    ctx.logSwiftlet.logWarning(tracePrefix, "This SMQP protocol version (v630) does NOT support accounting! Please upgrade this client to use accounting!");
  }
