...
public class JMSSource implements AccountingSource, TimerListener
{
  private static final String PROP_SWIFTLET = "swiftlet";
  private static final String PROP_SMQPVERSION = "smqpversion";
  ...
  public JMSSource(SwiftletContext ctx, long flushInterval, AccountingProfile accountingProfile)
  {
    this.ctx = ctx;
  ...
  {
    ctx.jmsSwiftlet.flushAccounting();
  }
  ...
  public synchronized void startAccounting(AccountingSink accountingSink) throws Exception
  {
    ...
    ctx.jmsSwiftlet.setAccountingProfile(accountingProfile);
  ...
  public synchronized void stopAccounting() throws Exception
  {
    ...
    ctx.jmsSwiftlet.setAccountingProfile(null);
  }

  public synchronized void send(String timestamp, String userName, String clientId, String remoteHostName, String smqpVersion, DestinationCollector collector)
  {
    if (accountingSink != null)
    {
      try
      {
        ...
        msg.setString(PROP_SWIFTLET, ctx.jmsSwiftlet.getName());
        msg.setStringProperty(PROP_SWIFTLET, ctx.jmsSwiftlet.getName());
        msg.setString(PROP_SMQPVERSION, smqpVersion);
        msg.setStringProperty(PROP_SMQPVERSION, smqpVersion);
