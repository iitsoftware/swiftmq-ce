...
public class JMSConnection
    ...
    public JMSConnection(SwiftletContext ctx, Entity connectionEntity, Connection connection) {
        ...
        connectionId = "v510/" + connection.toString();
    ...
    public void startAccounting(AccountingProfile accountingProfile) {
        ctx.logSwiftlet.logWarning(tracePrefix, "This SMQP protocol version (v510) does NOT support accounting! Please upgrade this client to use accounting!");
    }
