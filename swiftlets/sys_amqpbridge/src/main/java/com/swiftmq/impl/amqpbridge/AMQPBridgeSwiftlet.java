...
import com.swiftmq.impl.amqpbridge.accounting.AMQPBridgeSourceFactory;
import com.swiftmq.impl.amqpbridge.accounting.AccountingProfile;
import com.swiftmq.impl.amqpbridge.jobs.JobRegistrar;
import com.swiftmq.mgmt.*;
import com.swiftmq.swiftlet.Swiftlet;
import com.swiftmq.swiftlet.SwiftletException;

public class AMQPBridgeSwiftlet extends Swiftlet {
    com.swiftmq.impl.amqpbridge.SwiftletContext ctx = null;
    ...
    public void startAccounting(String bridgeType, String bridgeName, AccountingProfile accountingProfile) {
        ...
        if (bridgeType.equals("091")) {
            ...
            if (bridgeEntity != null) {
                com.swiftmq.impl.amqpbridge.v091.BridgeController bridgeController = (com.swiftmq.impl.amqpbridge.v091.BridgeController) bridgeEntity.getUserObject();
            ...
            if (bridgeEntity != null) {
                com.swiftmq.impl.amqpbridge.v100.BridgeController bridgeController = (com.swiftmq.impl.amqpbridge.v100.BridgeController) bridgeEntity.getUserObject();
                if (bridgeController != null)
                    bridgeController.startAccounting(accountingProfile);
            }
        }
    ...
    private void createAMQP100Adapter(EntityList list) throws SwiftletException {
        ...
        amqpbridge100Adapter = new EntityListEventAdapter(list, true, true) {
            public void onEntityAdd(Entity parent, Entity newEntity) throws EntityAddException {
                ...
                try {
                    com.swiftmq.impl.amqpbridge.v100.BridgeController bridgeController = new com.swiftmq.impl.amqpbridge.v100.BridgeController(ctx, newEntity);
            ...
            public void onEntityRemove(Entity parent, Entity delEntity) throws EntityRemoveException {
                ...
                com.swiftmq.impl.amqpbridge.v100.BridgeController bridgeController = (com.swiftmq.impl.amqpbridge.v100.BridgeController) delEntity.getUserObject();
        ...
        amqpbridge091Adapter = new EntityListEventAdapter(list, true, true) {
            public void onEntityAdd(Entity parent, Entity newEntity) throws EntityAddException {
                if (ctx.traceSpace.enabled)
                    ctx.traceSpace.trace(getName(), "onEntityAdd: " + newEntity.getName() + " ...");
                try {
                    com.swiftmq.impl.amqpbridge.v091.BridgeController bridgeController = new com.swiftmq.impl.amqpbridge.v091.BridgeController(ctx, newEntity);
                    newEntity.setUserObject(bridgeController);
                } catch (Exception e) {
                    throw new EntityAddException(e.toString());
                }
            ...
            public void onEntityRemove(Entity parent, Entity delEntity) throws EntityRemoveException {
                if (ctx.traceSpace.enabled)
                    ctx.traceSpace.trace(getName(), "onEntityRemove: " + delEntity.getName() + " ...");
                com.swiftmq.impl.amqpbridge.v091.BridgeController bridgeController = (com.swiftmq.impl.amqpbridge.v091.BridgeController) delEntity.getUserObject();
                bridgeController.close();
                if (ctx.traceSpace.enabled)
                    ctx.traceSpace.trace(getName(), "onEntityRemove: " + delEntity.getName() + " done");
            }
    ...
    protected void startup(Configuration config) throws SwiftletException {
        ctx = new com.swiftmq.impl.amqpbridge.SwiftletContext(config, this);
