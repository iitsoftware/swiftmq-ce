...
public class ConnectionEndException extends EndWithErrorException {
    public ConnectionEndException(ErrorConditionIF condition, AMQPString description) {
    ...
    public String toString() {
        return "ConnectionEndException, " + super.toString();
    }
}
