...
public class POMgmtMessage extends POObject {
    ManagementProcessor managementProcessor;
    Message message;

    public POMgmtMessage(Semaphore semaphore, ManagementProcessor managementProcessor, Message message) {
    ...
    public String toString() {
        return "[POMgmtMessage, managementProcessor=" + managementProcessor + "]";
    }
}
