...
import com.swiftmq.impl.jmsbridge.accounting.AccountingProfile;
import com.swiftmq.impl.jmsbridge.accounting.JMSBridgeSourceFactory;
import com.swiftmq.impl.jmsbridge.jobs.JobRegistrar;
...
public class JMSBridgeSwiftlet extends Swiftlet implements TimerListener {
    ...
    static final String TP_SVRMGR = "sys$jmsbridge.server.mgr";

    com.swiftmq.impl.jmsbridge.SwiftletContext ctx = null;
    ...
    public void startAccounting(String serverName, String bridgeName, AccountingProfile accountingProfile) {
        ...
        com.swiftmq.impl.jmsbridge.ServerBridge server = (com.swiftmq.impl.jmsbridge.ServerBridge) servers.get(serverName);
        if (server != null) {
            com.swiftmq.impl.jmsbridge.DestinationBridge bridge = server.getBridging(bridgeName);
            if (bridge != null)
    ...
    public synchronized void performTimeAction() {
        ...
        for (Iterator iter = servers.entrySet().iterator(); iter.hasNext(); ) {
            com.swiftmq.impl.jmsbridge.ServerBridge serverBridge = (com.swiftmq.impl.jmsbridge.ServerBridge) ((Map.Entry) iter.next()).getValue();
    ...
    private synchronized void destroyServer(Entity serverEntity, boolean closeIt) {
        com.swiftmq.impl.jmsbridge.ServerBridge server = (com.swiftmq.impl.jmsbridge.ServerBridge) servers.get(serverEntity.getName());
        if (server != null) {
            if (ctx.traceSpace.enabled)
    ...
    private synchronized void createServer(Entity serverEntity) throws Exception {
        ...
        servers.put(serverEntity.getName(), new com.swiftmq.impl.jmsbridge.ServerBridge(ctx, serverEntity));
    }
