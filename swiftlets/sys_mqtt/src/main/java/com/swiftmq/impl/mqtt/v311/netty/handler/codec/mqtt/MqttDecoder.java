...
import static com.swiftmq.impl.mqtt.v311.netty.handler.codec.mqtt.MqttCodecUtil.*;
...
public final class MqttDecoder {
    ...
    public MqttDecoder(int maxBytesInMessage) {
        decoderState = DecoderState.READ_FIXED_HEADER;
    ...
    public void decode(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer, List<MqttMessage> out) throws Exception {
        switch (state()) {
     ...
     */
    private static MqttFixedHeader decodeFixedHeader(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer) {
     ...
     */
    private static Result<?> decodeVariableHeader(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer, MqttFixedHeader mqttFixedHeader) {
    ...
    private static Result<MqttConnectVariableHeader> decodeConnectionVariableHeader(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer) {
    ...
    private static Result<MqttConnAckVariableHeader> decodeConnAckVariableHeader(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer) {
    ...
    private static Result<MqttMessageIdVariableHeader> decodeMessageIdVariableHeader(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer) {
    ...
    private static Result<MqttPublishVariableHeader> decodePublishVariableHeader(
            com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer,
    ...
    private static Result<Integer> decodeMessageId(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer) {
    ...
    private static Result<com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf> decodePublishPayload(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer, int bytesRemainingInVariablePart) {
        com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf b = buffer.readRetainedSlice(bytesRemainingInVariablePart);
        return new Result<com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf>(b, bytesRemainingInVariablePart);
    }

    private static Result<String> decodeString(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer) {
        return decodeString(buffer, 0, Integer.MAX_VALUE);
    }

    private static Result<String> decodeString(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer, int minBytes, int maxBytes) {
        ...
        String s = buffer.toString(buffer.readerIndex(), size, StringUtil.UTF8);
        buffer.skipBytes(size);
        numberOfBytesConsumed += size;
        return new Result<String>(s, numberOfBytesConsumed);
    }

    private static Result<byte[]> decodeByteArray(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer) {
        final Result<Integer> decodedSize = decodeMsbLsb(buffer);
        int size = decodedSize.value;
    ...
    private static Result<Integer> decodeMsbLsb(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer) {
