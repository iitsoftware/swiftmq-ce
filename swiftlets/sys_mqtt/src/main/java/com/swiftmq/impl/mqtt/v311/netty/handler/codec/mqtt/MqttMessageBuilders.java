...
public final class MqttMessageBuilders {
    ...
    public static final class PublishBuilder {
        ...
        private MqttQoS qos;
        private com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf payload;
        ...
        public PublishBuilder payload(com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf payload) {
        ...
        public MqttPublishMessage build() {
            ...
            com.swiftmq.impl.mqtt.v311.netty.buffer.ByteBuf buffer = new ByteBuf(payload.size());
            return new MqttPublishMessage(mqttFixedHeader, mqttVariableHeader, buffer.writeBytes(payload));
        }
    }
    ...
    public static final class ConnectBuilder {
        ...
        public ConnectBuilder willMessage(String willMessage) {
            willMessage(willMessage == null ? null : willMessage.getBytes(com.swiftmq.impl.mqtt.v311.netty.util.internal.StringUtil.UTF8));
            return this;
        }
        ...
        public ConnectBuilder password(String password) {
            password(password == null ? null : password.getBytes(StringUtil.UTF8));
            return this;
        }
