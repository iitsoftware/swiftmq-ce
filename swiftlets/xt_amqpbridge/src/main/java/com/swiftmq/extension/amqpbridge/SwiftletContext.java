...
import com.swiftmq.extension.amqpbridge.v100.Poller;
import com.swiftmq.extension.amqpbridge.v100.RouterTracer;
...
public class SwiftletContext {
    static final String CONNECTION_TOKEN = "extension.xt$amqpbridge.client.connection";
    static final String SESSION_TOKEN = "extension.xt$amqpbridge.client.session";
    static final String POLL_TOKEN = "extension.xt$amqpbridge.poller";
