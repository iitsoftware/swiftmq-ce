...
public class ConnectReplyRequest extends ReplyRequest {
    ...
    public void setRequestXA(boolean requestXA) {
        this.requestXA = requestXA;
    }

    public String toString() {
        return "[ConnectReplyRequest " + super.toString() + ", routerName=" + routerName + ", authRequired=" + authRequired + ", crFactory=" + crFactory + ", challenge=" + challenge + ", keepAliveInterval=" + keepAliveInterval + ", requestXA=" + requestXA + "]";
    }
}
