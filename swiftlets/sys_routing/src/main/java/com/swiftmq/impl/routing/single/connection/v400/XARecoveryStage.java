...
import com.swiftmq.impl.routing.single.smqpr.v400.CommitRequest;
import com.swiftmq.impl.routing.single.smqpr.v400.RecoveryReplyRequest;
import com.swiftmq.impl.routing.single.smqpr.v400.RecoveryRequest;
import com.swiftmq.impl.routing.single.smqpr.v400.StartDeliveryRequest;
...
public class XARecoveryStage extends Stage {
    ...
    private void doRecover(List localXids, List remoteXids) {
        ...
        if (!remoteRecoveryList.isEmpty()) {
            ...
            for (CommitRequest r : remoteRecoveryList) {
    ...
    protected void init() {
        ...
        visitor.setRequestHandler(com.swiftmq.impl.routing.single.smqpr.v400.SMQRFactory.RECOVERY_REPREQ, request -> {
            if (ctx.traceSpace.enabled)
                ctx.traceSpace.trace(ctx.routingSwiftlet.getName(), XARecoveryStage.this + "/visited, request=" + request + "...");
        ...
        visitor.setRequestHandler(com.swiftmq.impl.routing.single.smqpr.v400.SMQRFactory.RECOVERY_REQ, request -> {
            if (ctx.traceSpace.enabled)
                ctx.traceSpace.trace(ctx.routingSwiftlet.getName(), XARecoveryStage.this + "/visited, request=" + request);
        ...
        visitor.setRequestHandler(com.swiftmq.impl.routing.single.smqpr.v400.SMQRFactory.STARTDELIVERY_REQ, request -> {
            if (ctx.traceSpace.enabled)
                ctx.traceSpace.trace(ctx.routingSwiftlet.getName(), XARecoveryStage.this + "/visited, request=" + request + ", launching delivery stage");
    ...
    public void close() {
        ...
        visitor.setRequestHandler(com.swiftmq.impl.routing.single.smqpr.v400.SMQRFactory.RECOVERY_REQ, null);
        visitor.setRequestHandler(com.swiftmq.impl.routing.single.smqpr.v400.SMQRFactory.RECOVERY_REPREQ, null);
        visitor.setRequestHandler(com.swiftmq.impl.routing.single.smqpr.v400.SMQRFactory.COMMIT_REQ, null);
        visitor.setRequestHandler(com.swiftmq.impl.routing.single.smqpr.v400.SMQRFactory.STARTDELIVERY_REQ, null);
    }

    public String toString() {
        return routingConnection.toString() + "/v400XARecoveryStage, recoveryBranchQ=" + recoveryBranchQ;
    }
