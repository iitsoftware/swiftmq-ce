...
public class RoutingSwiftletImpl extends RoutingSwiftlet
{
    ...
    listenerList.setEntityAddListener(new EntityChangeAdapter(null)
    {
          ...
          throws EntityAddException
      {
        ...
        try
        {
          ...
          if (ctx.traceSpace.enabled) ctx.traceSpace.trace(getName(), "onEntityAdd (listener): listener=" + name);
        } catch (Exception e)
        {
  ...
  {
    if (ctx.traceSpace.enabled) ctx.traceSpace.trace("sys$routing", "starting connector: " + connectorEntity.getName());
    ...
    connectorList.setEntityAddListener(new EntityChangeAdapter(null)
    {
          ...
          throws EntityAddException
      {
        ...
        try
        {
          ...
          if (ctx.traceSpace.enabled) ctx.traceSpace.trace(getName(), "onEntityAdd (connector): connector=" + name);
        } catch (Exception e)
        {
          throw new EntityAddException(e.getMessage());
        }
  ...
  private void createStaticRoutes(EntityList staticRouteList) throws SwiftletException
  {
    ...
    if (staticRoutes != null)
    {
      ...
      {
        if (ctx.traceSpace.enabled) ctx.traceSpace.trace(getName(), "creating static route to: " + staticRoutes[i]);
        try
        {
  ...
  private class Acceptor implements com.swiftmq.swiftlet.net.event.ConnectionListener
  {
    ...
    public void connected(Connection connection) throws ConnectionVetoException
    {
      ...
      if (ctx.traceSpace.enabled) ctx.traceSpace.trace(getName(), "Acceptor/connected: " + connection + ", DONE.");
    }
    ...
    public void disconnected(Connection connection)
    {
      ...
      if (ctx.traceSpace.enabled) ctx.traceSpace.trace(getName(), "Acceptor/disconnected: " + connection + ", DONE.");
