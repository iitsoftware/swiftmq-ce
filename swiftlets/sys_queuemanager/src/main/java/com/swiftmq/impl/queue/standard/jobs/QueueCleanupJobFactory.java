...
public class QueueCleanupJobFactory implements JobFactory
{
  SwiftletContext ctx = null;
  Map parameters = new HashMap();

  public QueueCleanupJobFactory(SwiftletContext ctx)
  {
    this.ctx = ctx;
  ...
  {
    return "Cleanup expired Messages";
  }
  ...
  public Job getJobInstance()
  {
    ...
    return new QueueCleanupJob(ctx);
  }
