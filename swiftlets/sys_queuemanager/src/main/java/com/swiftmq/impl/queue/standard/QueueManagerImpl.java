    ...
    implements TimerListener
{
      ...
      throws UnknownQueueException, QueueException
  {
    ...
    {
      if (ctx.traceSpace.enabled) ctx.traceSpace.trace(getName(), "getQueue: Queue '" + queueName + "' is unknown");
      ...
      throws SwiftletException
  {
    ...
    if (collectOn)
    {
      ...
      {
        if (ctx.traceSpace.enabled) ctx.traceSpace.trace(getName(), "startup: registering message count collector");
