...
package amqp.v100.ps.one_to_n.durable.dedicatedsession.at_least_once;
    ...
    public static Test suite() {
        ...
        for (int i = 0; i < nPairs; i++) {
            for (int j = 0; j < nSubscribers; j++)
                suite.addTest(new Receiver("receive", QoS.AT_LEAST_ONCE, Util.getTopicNamePrefix() + (i + 1), "test-" + i + "-" + j));
