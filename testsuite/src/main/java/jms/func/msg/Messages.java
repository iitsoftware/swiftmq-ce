...
public class Messages extends SimpleConnectedPTPTestCase {
    ...
    public void testMessageImpl() {
        try {
            ...
            msg.setObjectProperty("Boolean2", Boolean.FALSE);
            ...
            assertEquals("Failed Byte1", msg.getByteProperty("Byte1"), (byte) 1);
            ...
            assertEquals("Failed Short1", msg.getShortProperty("Short1"), (short) 6);
            assertEquals("Failed String1", "StringValue1", msg.getStringProperty("String1"));
            assertEquals("Failed Boolean2", msg.getObjectProperty("Boolean2"), Boolean.FALSE);
            assertEquals("Failed Byte2", msg.getObjectProperty("Byte2"), (byte) 7);
            assertEquals("Failed Double2", msg.getObjectProperty("Double2"), 888.88);
            assertEquals("Failed Float2", msg.getObjectProperty("Float2"), 9F + 1);
            assertEquals("Failed Int2", msg.getObjectProperty("Int2"), 10);
            assertEquals("Failed Long2", msg.getObjectProperty("Long2"), 11L);
    ...
    public void testStreamMessageImpl() {
        try {
            ...
            sender.send(msg);
            msg = (StreamMessage) receiver.receive();
            assertTrue("Failed readBoolean (1)", msg.readBoolean());
            assertFalse("Failed readBoolean (2)", msg.readBoolean());
            assertEquals("Failed readByte (1)", msg.readByte(), (byte) 1);
            assertEquals("Failed readByte (2)", msg.readByte(), (byte) 255);
