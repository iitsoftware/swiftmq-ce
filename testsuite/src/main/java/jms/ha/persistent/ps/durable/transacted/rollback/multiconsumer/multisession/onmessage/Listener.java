...
package jms.ha.persistent.ps.durable.transacted.rollback.multiconsumer.multisession.onmessage;
...
public class Listener extends SimpleConnectedPSTestCase
{
  ...
  protected void setUp() throws Exception
  {
    ...
    session1 = tc.createTopicSession(true, Session.AUTO_ACKNOWLEDGE);
    session2 = tc.createTopicSession(true, Session.AUTO_ACKNOWLEDGE);
