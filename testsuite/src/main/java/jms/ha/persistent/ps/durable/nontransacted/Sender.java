...
package jms.ha.persistent.ps.durable.nontransacted;
...
public class Sender extends SimpleConnectedPSTestCase
{
  ...
  {
    s1 = tc.createTopicSession(false, Session.AUTO_ACKNOWLEDGE);
    s2 = tc.createTopicSession(false, Session.AUTO_ACKNOWLEDGE);
    s3 = tc.createTopicSession(false, Session.AUTO_ACKNOWLEDGE);
  }
  ...
  {
    setUp(false, Session.AUTO_ACKNOWLEDGE, true, true, false);
    pause(20000);
  }
