...
package jms.ha.persistent.ps.durable.nontransacted.autoack.multiconsumer.multisession.onmessage;
...
public class Listener extends SimpleConnectedPSTestCase
{
  ...
  protected void setUp() throws Exception
  {
    ...
    session1 = tc.createTopicSession(false, Session.AUTO_ACKNOWLEDGE);
    session2 = tc.createTopicSession(false, Session.AUTO_ACKNOWLEDGE);
