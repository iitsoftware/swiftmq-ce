...
package jms.ha.persistent.ptp.nontransacted.autoack.multiconsumer.multisession.onmessage;
...
public class Listener extends SimpleConnectedPTPTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        session1 = qc.createQueueSession(false, Session.AUTO_ACKNOWLEDGE);
        session2 = qc.createQueueSession(false, Session.AUTO_ACKNOWLEDGE);
