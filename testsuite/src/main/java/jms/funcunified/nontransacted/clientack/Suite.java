...
public class Suite extends TestSuite {
    public static Test suite() {
        ...
        suite.addTest(jms.funcunified.nontransacted.clientack.multireceiver.Suite.suite());
        suite.addTest(jms.funcunified.nontransacted.clientack.multisubscriber.Suite.suite());
        suite.addTest(jms.funcunified.nontransacted.clientack.exceptiontest.Suite.suite());
        return suite;
    }
