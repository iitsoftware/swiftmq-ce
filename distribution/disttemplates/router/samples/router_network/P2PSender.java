...
/**
 * P2P example to send messages to a [remote] queue. 
 *
 ...
 * router1 and sends a message to the queue 'testqueue@router2'.
 *
...
public class P2PSender
{
	public static void main(String[] args)
	{
		...
		{
			System.out.println();
			System.out.println("Usage: java P2PSender <smqpURL> <qcfName> <queueName> <nMsgs>\n");
