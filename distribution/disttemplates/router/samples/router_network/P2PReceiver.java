...
/**
 * P2P example to receive messages from a local queue. 
 *
 ...
 * router2 and receives a message from queue 'testqueue@router2'.
 *
...
public class P2PReceiver
{
	public static void main(String[] args)
	{
		...
		{
			System.out.println();
			System.out.println("Usage: java P2PReceiver <smqpURL> <qcfName> <queueName> <nMsgs>\n");
