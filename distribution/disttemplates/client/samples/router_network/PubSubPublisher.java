...
/**
 * PubSub example to publish messages to a topic. 
 *
 ...
 * - Number of messages to publish [1]
 *
 ...
 * router1 and publishs a message to the topic 'testtopic'.
 *
...
public class PubSubPublisher
{
	public static void main(String[] args)
	{
		...
		{
			System.out.println();
			System.out.println("Usage: java PubSubPublisher <smqpURL> <tcfName> <topicName> <nMsgs>\n");
		...
		try {
			...
			{
				msg.setText("Msg No: "+(i+1));
				System.out.println("Publishing "+msg.getText());
